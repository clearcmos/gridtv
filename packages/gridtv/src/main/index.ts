...
function init() {
  ...
  if (process.platform === 'linux') {
    // Match the desktop entry generated by the Linux packages. Electron uses
    // this as the Wayland application ID and X11 WM_CLASS; without it, desktop
    // environments can group gridtv under Electron's generic icon.
    app.setDesktopName('gridtv.desktop')
  }
