...
import { startGridtv } from './bootstrap'
...
startGridtv({
  squirrelStarted: started,
  app,
  platform: process.platform,
  initLogger,
  parseArgs,
  resolveConfigInitError,
  setLogLevel,
  initializeSentry: () => Sentry.init({ dsn: SENTRY_DSN }),
  sentryEnabledSwitch: SENTRY_ENABLED_SWITCH,
  sentryEnabledSwitchValue,
